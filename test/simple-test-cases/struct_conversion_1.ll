...
entry:
  ...
  %z1 = bitcast %struct.test* %z to i8*, !taffo.info !7
  %call = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), float* %a, float* %b, float* %c)
  %0 = load float, float* %a, align 4
  %a2 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 0, !taffo.info !7
  store float %0, float* %a2, align 4, !taffo.info !7
  %1 = load float, float* %b, align 4
  %conv = fptosi float %1 to i32
  %b3 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 1, !taffo.info !7
  store i32 %conv, i32* %b3, align 4, !taffo.info !7
  ...
  %a5 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 0, !taffo.info !7
  %3 = load float, float* %a5, align 4, !taffo.info !7
  %conv6 = fpext float %3 to double, !taffo.info !7
  %b7 = getelementptr inbounds %struct.test, %struct.test* %z, i32 0, i32 1, !taffo.info !7
  %4 = load i32, i32* %b7, align 4, !taffo.info !7
