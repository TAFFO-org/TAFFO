...
void u_normal()
{
  ...
  double __attribute__((annotate("scalar(range(1111111111.1, 1111111111.1))"))) c = deconstify(1111111111.1);
  double __attribute__((annotate("scalar(range(2222222222.2, 2222222222.2)) target('1')"))) d = c / a;
  printf("%lf\n", d);
}
...
void u_first_bigger()
{
  ...
  double __attribute__((annotate("scalar() target('2')"))) d = c / a;
  printf("%lf\n", d);
}
...
void s_first_bigger()
{
  double __attribute__((annotate("scalar(range(-1234567000.9, 1234567000.9))"))) c = deconstify(-123456.9);
  double __attribute__((annotate("scalar(range(-1111111111.1, 1111111111.1))"))) a = deconstify(-1111111111.1);
  double __attribute__((annotate("scalar() target('4')"))) d = c / a;
  printf("%lf\n", d);
}
...
void u_same()
{
  ...
  double __attribute__((annotate("scalar(type(64 10)) target('5')"))) d = c / c;
  printf("%lf\n", d);
}
...
void u_same_bigger_float()
{
  ...
  double __attribute__((annotate("scalar(type(64 40)) target('5')"))) d = c / a;
  printf("%lf\n", d);
}
