...
/* Variable declaration/allocation. */
  ...
  PB_STATIC DATA_TYPE __attribute__((annotate("scalar(range(-256, 255) final error(1e-100)) target('x1')"))) x1[N];
  PB_STATIC DATA_TYPE __attribute__((annotate("scalar(range(-256, 255) final error(1e-100)) target('x2')"))) x2[N];
