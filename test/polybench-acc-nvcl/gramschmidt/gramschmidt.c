...
{	
  ...
  ANN_R POLYBENCH_2D_ARRAY_DECL(R_outputFromGpu,DATA_TYPE,NJ,NJ,nj,nj);
	...
	errcode = clEnqueueReadBuffer(clCommandQue, r_mem_obj, CL_TRUE, 0, NJ*NJ*sizeof(DATA_TYPE), POLYBENCH_ARRAY(R_outputFromGpu), 0, NULL, NULL);
	if(errcode != CL_SUCCESS) printf("Error in reading GPU mem\n");
  errcode = clEnqueueReadBuffer(clCommandQue, q_mem_obj, CL_TRUE, 0, NI*NJ*sizeof(DATA_TYPE), POLYBENCH_ARRAY(Q_outputFromGpu), 0, NULL, NULL);
	if(errcode != CL_SUCCESS) printf("Error in reading GPU mem\n");
