...
int main(int argc, char** argv) {
  ...
  POLYBENCH_2D_ARRAY_DECL(
    E, DATA_TYPE __attribute__((annotate("target('E') scalar(range(0, 10000000000) final)"))), NI, NJ, ni, nj);
  ...
  POLYBENCH_2D_ARRAY_DECL(
    F, DATA_TYPE __attribute__((annotate("target('F') scalar(range(0, 10000000000) final)"))), NJ, NL, nj, nl);
  ...
  POLYBENCH_2D_ARRAY_DECL(
    G, DATA_TYPE __attribute__((annotate("target('G') scalar(range(0, 5000000000000000000) final)"))), NI, NL, ni, nl);
