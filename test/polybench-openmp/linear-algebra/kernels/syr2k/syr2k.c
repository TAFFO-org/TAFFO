...
int main(int argc, char** argv) {
  ...
  POLYBENCH_2D_ARRAY_DECL(
    C, DATA_TYPE __attribute__((annotate("target('C') scalar(range(0, 120000000000000) final)"))), NI, NI, ni, ni);
  ...
  /* Run kernel. */
  kernel_syr2k(ni, nj, alpha, beta, POLYBENCH_ARRAY(C), POLYBENCH_ARRAY(A), POLYBENCH_ARRAY(B));
