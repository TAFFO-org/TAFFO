...
int BENCH_MAIN(int argc, char** argv)
{
  ...
  DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_alpha_MIN) "," PB_XSTR(VAR_alpha_MAX) "))"))) alpha;
  DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_beta_MIN) "," PB_XSTR(VAR_beta_MAX) "))"))) beta;
  POLYBENCH_2D_ARRAY_DECL(A, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_A_MIN) "," PB_XSTR(VAR_A_MAX) "))"))), N, N, n, n);
  POLYBENCH_1D_ARRAY_DECL(u1, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_u1_MIN) "," PB_XSTR(VAR_u1_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(v1, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_v1_MIN) "," PB_XSTR(VAR_v1_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(u2, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_u2_MIN) "," PB_XSTR(VAR_u2_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(v2, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_v2_MIN) "," PB_XSTR(VAR_v2_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(w, DATA_TYPE __attribute((annotate("target('w') scalar(range(" PB_XSTR(VAR_w_MIN) "," PB_XSTR(VAR_w_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(x, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_x_MIN) "," PB_XSTR(VAR_x_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(y, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_y_MIN) "," PB_XSTR(VAR_y_MAX) "))"))), N, n);
  POLYBENCH_1D_ARRAY_DECL(z, DATA_TYPE __attribute((annotate("scalar(range(" PB_XSTR(VAR_z_MIN) "," PB_XSTR(VAR_z_MAX) "))"))), N, n);
