...
llvm::cl::opt<std::string>
  BufferIDImport("bufferid-import", llvm::cl::desc("File from where to import buffer ID types"), llvm::cl::init(""));
...
llvm::cl::opt<bool> MixedMode("mixedmode",
                              llvm::cl::desc("Enable or disable the experimental mixed-precision mode"),
                              llvm::cl::init(false));

llvm::cl::opt<double>
  MixedTuningENOB("mixedtuningenob",
                  llvm::cl::value_desc("Enob importance"),
                  llvm::cl::desc("Set the importance given to the best ENOB preservation in mixed precision mode"),
                  llvm::cl::init(1));

llvm::cl::opt<double>
  MixedTuningTime("mixedtuningtime",
                  llvm::cl::value_desc("Time importance"),
                  llvm::cl::desc("Set the importance to keep down the computation time in mixed precision mode"),
                  llvm::cl::init(1));
llvm::cl::opt<double> MixedTuningCastingTime(
  "mixedtuningcastingtime",
  llvm::cl::value_desc("Casting time importance"),
  llvm::cl::desc("Set the importance to keep down the computation  casting time in mixed precision mode"),
  llvm::cl::init(1));

llvm::cl::opt<bool> MixedDoubleEnabled("mixeddoubleenabled",
                                       llvm::cl::value_desc("Double enabled"),
                                       llvm::cl::desc("Set if the double dataype can be used in the resulting mix"),
                                       llvm::cl::init(true));

llvm::cl::opt<bool> MixedTripCount("mixedtripcount",
...
llvm::cl::opt<std::string>
  CostModelFilename("costmodelfilename",
                    llvm::cl::value_desc("Cost model filename"),
...
llvm::cl::opt<std::string, true>
  InstructionSetFlag("instructionsetfile",
                     llvm::cl::value_desc("Instruction file name"),
                     llvm::cl::desc("Set the filename to load wich instruction set are allowed"),
                     llvm::cl::location(InstructionSet),
                     llvm::cl::init("DOES-NOT-EXIST"));
