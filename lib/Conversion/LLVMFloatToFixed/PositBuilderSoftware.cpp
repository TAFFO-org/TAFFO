...
Value *PositBuilderSoftware::getAlloc(unsigned idx, const FixedPointType &target) {
...
Value *PositBuilderSoftware::CreateConstructor(Value *arg1, const FixedPointType *srcMetadata) {
  if (srcMetadata && srcMetadata->isPosit()) {
    return PositBuilderSoftware(pass, builder, *srcMetadata).CreateConv(arg1, llvmType, &metadata);
  }
...
Value *PositBuilderSoftware::CreateBinOp(int opcode, Value *arg1, Value *arg2) {
...
Value *PositBuilderSoftware::CreateUnaryOp(int opcode, Value *arg1) {
...
Value *PositBuilderSoftware::CreateCmp(CmpInst::Predicate pred, Value *arg1, Value *arg2) {
...
Value *PositBuilderSoftware::CreateConv(Value *from, Type *dstType, const FixedPointType *dstMetadata) {
...
Value *PositBuilderSoftware::CreateFMA(Value *arg1, Value *arg2, Value *arg3) {
  const char* mangledName;
  switch (metadata.scalarBitsAmt()) {
  case 32:
