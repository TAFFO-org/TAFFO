...
const std::map<const std::string, map_value_t> taffo::functionWhiteList =
    {
        ...
        CMATH_WHITELIST_FUN("__dev-sin", &handleCallToSin),
        CMATH_WHITELIST_FUN("__dev-cos", &handleCallToCos),
        CMATH_WHITELIST_FUN("__dev-acos", &handleCallToAcos),
        CMATH_WHITELIST_FUN("__dev-asin", &handleCallToAsin),
