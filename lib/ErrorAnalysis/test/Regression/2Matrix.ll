; RUN: opt -load %errorproplib --load-pass-plugin=%errorproplib --passes="require<globals-aa>,function(require<cfl-steens-aa>,require<cfl-anders-aa>,require<tbaa>),taffoerr" -nounroll -S %s | FileCheck %s
